      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="bg-[#1E40AF] text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
          >
            + Add Device
          </button>
        </div>
        ...
        {devices.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {devices.map((device) => (
              <div
                key={device.id}
                className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 p-5 flex flex-col justify-between border border-gray-200"
              >
                <div>
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <Link
                      ...
                      className="flex-1 text-center py-2 px-4 bg-[#1E40AF] text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium"
                    >
                      Dashboard
                    </Link>
                  </div>
                  <div className="flex gap-2">
                    <Link
                      ...
                      className="flex-1 text-center py-2 px-4 bg-gray-100 text-[#1E40AF] rounded-lg hover:bg-gray-200 transition-colors duration-200 font-medium"
                    >
                      Thresholds
                    </Link>
                    <button
                      onClick={() => handleEditDevice(device)}
                      className="flex-1 py-2 px-4 bg-gray-100 text-[#1E40AF] rounded-lg hover:bg-gray-200 transition-colors duration-200 font-medium"
                    >
                      Edit
                    </button>
                    <button
                      onClick={() => handleDetachDevice(device.deviceId)}
                      className="flex-1 py-2 px-4 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 transition-colors duration-200 font-medium"
                    >
                      Detach
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <form onSubmit={handleAddDevice}>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    className="flex-1 bg-[#1E40AF] text-white px-4 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
                    disabled={submitting}
                  >
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <form onSubmit={handleSubmitEdit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-100 text-gray-600"
